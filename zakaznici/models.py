...
class MobilniOperator(models.Model):
    ...
    email = models.EmailField(max_length=50, unique=True, blank=True, null=True, verbose_name='Email operátora')

    class Meta:
        ordering = ['nazev']

    def __str__(self):
        return f'Nazev: {self.nazev} email: {self.email}'
...
class Zakaznik(models.Model):
    ...
    druhotne_sluzby = models.ManyToManyField(DruhotneSluzby,
...
class Tarif(models.Model):
    ...
    cena = models.DecimalField(max_digits=5,decimal_places=2, verbose_name='Cena tarifu')
